package com.auction.kafka.app.util;
...
public @interface MethodStartEndLogger {
    ...
    class MethodStartEndLoggerAspect {
        ...
        private static final String LOG_INFO_START = "LOG_INFO_METHOD_START_MSG".concat(" :: {}");
        private static final String LOG_INFO_WITH_ARGS_START = LOG_INFO_START.concat(" :: argument names: {}, argument values: {}");
        private static final String LOG_INFO_END = "LOG_INFO_METHOD_END_MSG".concat(" :: {}");

        @Around("@annotation(com.auction.kafka.app.util.MethodStartEndLogger) && @annotation(methodStartEndLogger)")

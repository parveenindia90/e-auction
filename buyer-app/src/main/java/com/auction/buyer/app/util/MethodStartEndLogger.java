...
public @interface MethodStartEndLogger {
    ...
    class MethodStartEndLoggerAspect {
        ...
        private static final String LOG_INFO_START = BuyerConstants.LOG_INFO_METHOD_START_MSG.concat(" :: {}");
        private static final String LOG_INFO_WITH_ARGS_START = LOG_INFO_START.concat(" :: argument names: {}, argument values: {}");
        private static final String LOG_INFO_END = BuyerConstants.LOG_INFO_METHOD_END_MSG.concat(" :: {}");

        @Around("@annotation(com.auction.buyer.app.util.MethodStartEndLogger) && @annotation(methodStartEndLogger)")

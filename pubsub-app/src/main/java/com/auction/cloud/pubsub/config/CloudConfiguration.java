package com.auction.cloud.pubsub.config;


import com.auction.cloud.pubsub.config.aws.Container;
import com.auction.cloud.pubsub.config.aws.Converter;
import com.auction.cloud.pubsub.config.aws.EcsTaskMetadata;
import com.auction.cloud.pubsub.config.aws.Network;
...
public class CloudConfiguration {
    ...
    private static final String DOCKER_CONTAINER_NAME = "pubsub-app";
